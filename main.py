...
if __name__ == '__main__':
    ...
    #
    # if answer == 'y':
    aws_batch = AWSBatch(req_batches, cfg["max_vpus"], cfg["batch_size"], batches_per_partition,
                         cfg['output_bucket'], result_output_path, cfg['image_name'], cfg['batch_role'],
                         keywords_path=cfg['keywords_path'], retry_attempts=cfg['retry_attempts'],
